...
import infrastructure/product_repository/sqlite_product_repository/child_references_port as product_child_references_adapter
...
import infrastructure/product_repository/sqlite_product_repository/stock_references_port as product_stock_references_adapter
import sqlight
import wisp
...
pub fn compose(
  ...
  let product_stock_repo = product_stock_references_adapter.new(connection)
  let product_child_repo = product_child_references_adapter.new(connection)
