...
import infrastructure/product_repository/sqlite_product_repository/get_port as product_get_adapter
import infrastructure/product_repository/sqlite_product_repository/list_child_ids_port as product_list_child_ids_adapter
...
pub fn compose(
  ...
  let product_get_repo = product_get_adapter.new(connection)
  ...
  let product_list_child_ids_repo =
    product_list_child_ids_adapter.new(connection)
